...
public class RedisClient {
    ...
    public Object eval(String script, int keyCount, String... params) {
        Jedis jedis = getJedis();
        Object ret = jedis.eval(script, keyCount, params);
        returnJedis(jedis);
        return ret;
    }
    ...
    public Object evalsha(String script, int keyCount, String... params) {
        Jedis jedis = getJedis();
        Object ret = jedis.evalsha(script, keyCount, params);
        returnJedis(jedis);
        return ret;
    }
    ...
    public long time() {
        Jedis jedis = getJedis();
        List<String> timex = jedis.time();
        long ret = Long.valueOf(timex.get(0)) * 1000 + Long.valueOf(timex.get(1)) / 1000;
        returnJedis(jedis);
        return ret;
    }
